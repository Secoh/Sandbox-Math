...
that its Lehmer's measure can be made arbitrarily small only by selecting the first term.
...
terms one by one.
To simplify tracking the Machin terms and ``remainders'' in~\mref{machin-switch}
...
arctanget~\mref{maclaurin2}. The error of calculating the arctangent function
